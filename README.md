...
* [X] Added "EndDate" filter for better search results!
* [X] Implemented my own Parcelable models, didnt use provided built in parcelable. 

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/KUVzSWQ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
